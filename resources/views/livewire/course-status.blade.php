        ...
        <div class="lg:col-span-2">
            ...
            <div class="card mt-2">
                <div class="card-body flex text-gray-500 font-bold">
                    ...
                    @endif
                    @if ($this->next)
                        <a wire:click="changeLesson({{$this->next}})" class="ml-auto cursor-pointer">Lección siguiente</a>
                    @endif
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-gray-600 text-sm mt-2">
                    {{$this->progress}}% completado
                </p>

                <div class="relative pt-1">
                    <div class="overflow-hidden h-2 mb-4 text-xs flex rounded bg-gray-200">
                      <div style="width:{{$this->progress}}%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-500 transition-all duration-300"></div>
                    </div>
                  </div>
